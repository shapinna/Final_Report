...
* coefficeient as.factor(region)East Asia & Pacific -5.906e-01 denotes difference in intercept  between reference category region = America and region =East Asia & Pacific, while all other variables are zero including income
...
* coefficeient as.factor(region)Europe & Central Asia 3.990e+00   denotes difference in intercept  between reference category region = America and region =Europe & Central Asia, while all other variables are zero including income
...
* coefficeient as.factor(region)Middle East & North Africa -9.524e-01   denotes difference in intercept  between reference category region = America and region =Middle East & North Africa, while all other variables are zero including income
...
* coefficeient as.factor(region)South Asia -7.609e+00   denotes difference in intercept  between reference category region = America and region =South Asia, while all other variables are zero including income
...
* coefficeient as.factor(region)Sub-Saharan Africa -3.843e+00  denotes difference in intercept  between reference category region = America and region =Sub-Saharan Africa, while all other variables are zero including income
...
* Coefficeient income:as.factor(region)East Asia & Pacific -4.265e-04  denotes the slope difference between income for the reference category = America & East Asia & Pacific, as the slope for reference cateogry is 9.140e-04  slope for income for East Asia & Pacific = 9.140e-04-4.265e-04 = 0.0004875
  - P value < 2e-16 <0.05 indicates variation in life is explained by variation in income where region is East Asia & Pacific

* Coefficeient income:as.factor(region)Europe & Central Asia -3.204e-04 denotes the slope difference between income for the reference category = America & Europe & Central Asia, as the slope for reference cateogry is 9.140e-04  slope for income for Europe & Central Asia = 9.140e-04 -3.204e-04 = 
  - P value < 2e-16 <0.05 indicates variation in life is explained by variation in income where region is Europe & Central Asia

* Coefficeient income:as.factor(region)Middle East & North Africa -6.531e-04  denotes the slope difference between income for the reference category = America & Middle East & North Africa, as the slope for reference cateogry is 9.140e-04  slope for income for Middle East & North Africa = 9.140e-04 -6.531e-04 =
...
* Coefficeient income:as.factor(region)South Asia 2.332e-03 denotes the slope difference between income for the reference category = America & South Asia, as the slope for reference cateogry is 9.140e-04  slope for income for South Asia = 9.140e-04+2.332e-03 = 0.0004875
  - P value < 2e-16 <0.05 indicates variation in life is explained by variation in income where region is South Asia
  
* Coefficeient income:as.factor(region)Sub-Saharan Africa -2.071e-04  denotes the slope difference between income for the reference category = Sub-Saharan Africa, as the slope for reference cateogry is 9.140e-04  slope for income for Sub-Saharan Africa = 9.140e-04 -2.071e-04  = 
 ...
 **Whether life expectancy increases based on Income?**
  ...
  - As per above linear regression modle with interaction term where Life is dependent on Income with year and region, Adjusted R squared is 0.7514 it represents Variation in Life (dependent variable) to the extent of 75% is explained by variation in income(indpendent variable) by controlling Year and Region
 ...
 **Whether population increased where life expectancy is more?**
  ...
  - As per above linear regression model is not valid for where population is dependent on life hence we cannot conclude that high life will have high population
