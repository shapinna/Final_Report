...
* Intercept $\alpha$ 38.73 indicates intercept value while all other values are zero in a linear regression model
  - P value <2e-16 < 0.05 indicates that it is statistically singnificant at $\alhpa$ 0.05 level
...
* Income coefficient estimate 0.0009217 indicates
  ...
  - test statistic t = 139.2 & P value <2e-16 < 0.05 indicates that it is statistically singnificant at $\alhpa$ 0.05 level and we reject null hypothesis of $\beta$ =0
...
* Intercept $\alpha$ -6315250 indicates intercept value while all other values are zero in a linear regression model
  - P value 2.33e-13  < 0.05 indicates that it is statistically singnificant at $\alhpa$ 0.05 level
...
* Income coefficient estimate 441077 indicates
  ...
  - test statistic t = 23.474 & P value <2e-16 < 0.05 indicates that it is statistically singnificant at $\alhpa$ 0.05 level and we reject null hypothesis of $\beta$ =0
...
silhouette_score <- function(k){
  km <- kmeans(gap_1, centers = k, nstart=25)
  ss <- silhouette(km$cluster, dist(gap_1))
  mean(ss[, 3])
}
k <- 2:10
...
fviz_nbclust(gap_1, kmeans, method='silhouette')
```{r}
